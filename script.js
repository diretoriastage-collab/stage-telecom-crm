...
// ===== CONFIGURAÇÕES =====
const GOOGLE_SHEET_VENDAS_URL = 'https://script.google.com/macros/s/AKfycbz8-p6KUESGw-H_DRHMLgnVdaWqp0yjObBEiXDOMsb7Cgh2_fViYBgageqYiRDz1dHy/exec';
        ...
        if (resp && resp.pendentes && Array.isArray(resp.pendentes)) {
            const pendentesNuvem = resp.pendentes.map(p => {
                ...
                return {
                    ...
                    produto: p.Plano || '',
                    plano: p.Plano || '',
                    origem: p.Origem || '', // <-- ADICIONADO AQUI
...
async function abrirModalAtivacao(id) {
    ...
    '<div class="form-grid" style="grid-template-columns: 1fr 1fr 1fr; gap: 10px;">' +
        ...
        '<div class="input-group"><label>Origem</label><input value="' + (a.origem || '') + '" id="editOrigem"></div>' +
...
async function fecharModalAtivacao() {
    ...
    if (a) {
        ...
        a.origem = document.getElementById('editOrigem') ? document.getElementById('editOrigem').value : '';
